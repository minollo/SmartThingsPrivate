 ...
 */
metadata {
	definition (name: "SmartSense Motion always notify battery", namespace: "smartthings", author: "SmartThings") {
...
private getBatteryResult(part, description) {
	...
	def isStateChange = true  //isStateChange(device, name, value)
