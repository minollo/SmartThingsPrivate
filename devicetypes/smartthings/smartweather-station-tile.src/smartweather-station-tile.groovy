...
def poll() {
	...
	if (obs) {
		...
		if(getTemperatureScale() == "C") {
			send(name: "temperature", value: obs.temp_c, unit: "C")
			send(name: "feelsLike", value: obs.feelslike_c as Double, unit: "C")
		} else {
			send(name: "temperature", value: obs.temp_f, unit: "F")
			send(name: "feelsLike", value: obs.feelslike_f as Double, unit: "F")
		}
